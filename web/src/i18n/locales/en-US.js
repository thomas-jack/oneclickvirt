export default {
  ...
  admin: {
    ...
    providers: {
      ...
      batchHealthCheckConfirm: 'Are you sure you want to perform health check on the selected {count} node(s)?',
      confirmHealthCheck: 'Confirm Health Check',
      batchHealthChecking: 'Batch health checking...',
      batchHealthCheckFailed: 'Batch health check operation failed',
